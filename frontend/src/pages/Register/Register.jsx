        ...
        <form className="register-form" onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              />
              {errors.fullName && (
                <p className="field-error" role="alert">{errors.fullName.message}</p>
              )}
            </div>
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              {errors.country && (
                <p className="field-error" role="alert">{errors.country.message}</p>
              )}
            </div>
          </div>

          {/* Row 3: Organisation Name + Role */}
          <div className="form-row">
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              {errors.role && (
                <p className="field-error" role="alert">{errors.role.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              {/* Controller used so field.value is available for live strength checklist */}
              <Controller
                name="password"
                control={control}
                render={({ field }) => (
          ...
          <div className="form-group terms-group">
            ...
            {errors.terms && (
              <p className="field-error" role="alert">{errors.terms.message}</p>
            )}
          </div>
