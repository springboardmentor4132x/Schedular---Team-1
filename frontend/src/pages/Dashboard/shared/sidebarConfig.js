...
export const SIDEBAR_CONFIG = {
  [ROLES.BUSINESS]: [
    ...
    { label: 'Analytics',         to: '/business/analytics',  icon: 'MdInsights'          },
    { label: 'Reports',           to: '/business/reports',    icon: 'MdBarChart'          },
  ...
  [ROLES.MARKETING]: [
    ...
    { label: 'Analytics',          to: '/marketing/analytics', icon: 'MdInsights'         },
    { label: 'Reports',            to: '/marketing/reports',   icon: 'MdBarChart'         },
